  ...
  return (
    ...
    <div className='pb-5'>
        <div className='flex justify-between items-center'>
            ...
            <img src={assets.logo} alt="" className='max-h-5' />
            <div className='relative py-2 group'>
                <img src={assets.menu_icon} alt="" className="max-h-5 cursor-pointer" />
                <div className='absolute top-full right-0 z-20 w-32 p-5 rounded-md bg-[#282142] border border-gary-600 text-gray-100 hidden group-hover:block'>
        ...
        <div className='bg-[#282142] rounded-full flex items-center gap-2 py-3 px-4 mt-5'>
            ...
            <input type='text' className='bg-transparent border-none outline-none
             text-white text-xs placeholder-[#c8c8c8] flex-1' placeholder='Search User Here...'/>
        </div>
    ...
    <div className='flex flex-col'>
        {userDummyData.map((user,index)=>(
            ...
            cursor-pointer max-sm:text-sm ${selectedUser?._id === user._id && 'bg-[#282142]/50'}`}>
                ...
                {index >2 && <p className='absolute top-4 right-4 text-x5 h-5 w-5
